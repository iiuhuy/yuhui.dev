    ...
    <div className="blog-container" name="blog">
      <div className="content-section">
        ...
        <div className="section-heading">
          I write about my Startups, Projects, Life experience, daily hacks - I
          do in my Projects.
        </div>
        <div className="blog-cards">
                  ...
                  <div className="blog-post-item">
                    <div className="post-card">
                      <div className="post-title">
                        <Link to={`/${getSlug(item.title)}-${item.number}`}>
                          {item.title}
                        </Link>
                      </div>
                      ...
                      <div className="summary">
                        <Markdown className="body-markdown">{summary}</Markdown>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          {!showAll && (
            <Link to="/blog">View all {postArray.length} articles</Link>
          )}
        </div>
      </div>
    </div>
